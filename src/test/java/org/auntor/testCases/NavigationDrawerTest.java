...
15. Verify Navigation Drawer option About is working properly or not.
 */
...
public class NavigationDrawerTest extends BaseClass {
    ...
    public void checkNavigationDrawerOptionAndText() throws IOException {
    ...
    public void checkNavigationDrawerScrolling() throws IOException {
        navigationDrawer = new NavigationDrawer(driver);
        homePage = new HomePage(driver);
        homePage.pressNavigationDrawer();
...
//    public void checkNavDrawerNoticeBoardOption() throws IOException {
//        homePage = new HomePage(driver);
//        navigationDrawer = new NavigationDrawer(driver);
//        homePage.pressNavigationDrawer();
...
//    public void checkNavStudentPortalOption() throws IOException {
//        homePage = new HomePage(driver);
//        navigationDrawer = new NavigationDrawer(driver);
//        homePage.pressNavigationDrawer();
...
//    public void checkNavAdministrationOption() throws IOException {
//        homePage = new HomePage(driver);
//        navigationDrawer = new NavigationDrawer(driver);
//        homePage.pressNavigationDrawer();
...
//    public void checkNavFacultyMemberOption() throws IOException {
//        homePage = new HomePage(driver);
//        navigationDrawer = new NavigationDrawer(driver);
//        homePage.pressNavigationDrawer();
...
//    public void checkNavAcademicResultOption() throws IOException {
//        homePage = new HomePage(driver);
//        navigationDrawer = new NavigationDrawer(driver);
//        homePage.pressNavigationDrawer();
...
//    }
    ...
    public void checkNavAcademicCalenderOption() throws IOException {
        homePage = new HomePage(driver);
        navigationDrawer = new NavigationDrawer(driver);
        homePage.pressNavigationDrawer();
    ...
    public void checkNavRulesAndRegulationOption() throws IOException {
        homePage = new HomePage(driver);
        navigationDrawer = new NavigationDrawer(driver);
        homePage.pressNavigationDrawer();
    ...
    public void checkNavExaminationGuidelineOption() throws IOException {
        homePage = new HomePage(driver);
        navigationDrawer = new NavigationDrawer(driver);
        homePage.pressNavigationDrawer();
    ...
    public void checkNavProspectiveStudentsOption() throws IOException {
    ...
    public void checkNavCreditTransferOption() throws IOException {
        homePage = new HomePage(driver);
        navigationDrawer = new NavigationDrawer(driver);
        homePage.pressNavigationDrawer();
    ...
    public void checkNavSettingsOption() throws IOException {
        homePage = new HomePage(driver);
        navigationDrawer = new NavigationDrawer(driver);
        homePage.pressNavigationDrawer();
    ...
    @Test(priority = 15, description = "Verify Navigation Drawer option About is working properly or not")
    public void checkNavAboutOption() throws IOException {
        homePage = new HomePage(driver);
        navigationDrawer = new NavigationDrawer(driver);
        homePage.pressNavigationDrawer();
        if (navigationDrawer.getAboutPageTitleText().equals("About Developer")) {
            logger.info("Test Passed");
            Assert.assertTrue(true);
        } else {
            logger.warn("Test Failed");
            captureScreen("checkNavAboutOption");
            Assert.assertTrue(false);
        }
